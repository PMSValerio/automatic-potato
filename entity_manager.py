...
class EntityManager:
    def __init__(self):
        ...
        # all entities are deleted at the end of the update at the same time
        self.remove_queue = [] 
    ...
    def draw_all(self, surface):
        # sort according to y coordinate, so that entities located above on the screen will be drawn first
